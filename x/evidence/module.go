...
import (
	...
	"github.com/ayher/project-anatha/x/evidence/client"
	"github.com/ayher/project-anatha/x/evidence/client/cli"
	"github.com/ayher/project-anatha/x/evidence/client/rest"
